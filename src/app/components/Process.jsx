...
//       tl.fromTo(card, 
//         { opacity: 0, y: 50, borderColor: "transparent" }, 
//         { opacity: 1, y: 0, borderColor: "#FFFFFF", duration: 0.2 }
//       ).to(card, { borderColor: "transparent", duration: 0.2}, "+=0.5");
//     });

//     gsap.fromTo(dotRefs.current,
//       { opacity: 0, scale: 0.8 },
//       { opacity: 1, scale: 1, stagger: 0.2, duration: 2, delay: 0.1 }
//     );
//   }, []);
...
const Process = () => {
  ...
  useEffect(() => {
    ...
    cardRefs.current.forEach((card, index) => {
      tl.fromTo(card,
        { opacity: 0, y: 50, borderColor: "transparent" },
        { opacity: 1, y: 0, borderColor: "#FFFFFF", duration: 0.8, ease: "power2.out" },
        index * 0.3 
      ).to(card, { borderColor: "transparent", duration: 0.9 }, "+=0.5");
    });
